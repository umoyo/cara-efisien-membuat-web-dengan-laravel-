...
<body >
<h1>Ganti Kategori</h1>
<form method="post" action="{{ url('admin/kategori',$kategori->slug) }}">
          ...
          <div class="form-group">
              ...
              <input type="textarea" class="form-control" name="deskripsi" value="{{$kategori->deskripsi}}"/>
          </div>
