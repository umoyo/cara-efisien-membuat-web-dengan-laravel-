...
<p><a href="{{url('admin/kategori/'.$kategori->slug.'/create')}}" class="btn btn-success">Tambah</a></p>
</font>
...
<div class="row">
<div class="col-sx-4">
<a href="{{url('admin/kategori/'.$kategori->slug, $ajar->slug)}}" class="btn btn-primary">Isi kategori</a>
</div>
<div class="col-sx-4">
<a href="{{url('admin/kategori/'.$ajar->slug.'/edit')}}" ><span class = "btn btn-success glyphicon glyphicon-edit"></span></a>
</div>
<div class="col-sx-4">
	{!! Form::open(['method' => 'DELETE', 'url'=>['admin/kategori/'. $ajar->slug]]) !!}
	{!! Form::button('<span class = "glyphicon glyphicon-trash"></span>', ['type' => 'submit','class'=>'btn btn-warning']) !!}
	{!! Form::close() !!}
</div></div>
</td>
</tr>
