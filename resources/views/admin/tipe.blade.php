...
@elseif (Session::get('alert-ganti'))
  ...
  @elseif (Session::get('alert-hapus'))
...
<div class="row">
<div class="col-sx-4">
<a href="{{url('admin/kategori/'.$kategori->slug.'/'.$ajar->slug.'/edit')}}" ><span class = "btn btn-success glyphicon glyphicon-edit">Ganti</span></a>
</div>
<div class="col-sx-4">
<form method="post" action="{{url('admin/kategori/tipe/'.$ajar->id)}}">@csrf  @method('delete')<input type="submit" name="hapus" value="hapus"> </form>
</div>
</div>
</td>
</tr>
